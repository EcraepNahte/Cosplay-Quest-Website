...
def create_beta_signup(db: Session, name: str, email: str, device_os: str, next_con: str = None, next_con_date: datetime = None, will_cosplay: bool = False, character: str = None, source_media: str = None):
    db_beta_signup = models.BetaSignup(name=name, email=email, device_os=device_os, next_con=next_con, next_con_date=next_con_date, will_cosplay=will_cosplay, character=character, source_media=source_media)
